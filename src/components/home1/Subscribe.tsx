...
const Subscribe = () => {
    ...
    return (
        <Container>
            <div className='w-full px-24 py-[1.4rem] mt-4 flex flex-col  gap-10 md:gap-1 items-center md:items-end'>
                <div className='rounded-[22px] w-full flex items-center gap-16 px-8 py-12 bg-[#0D0D0D]'>
                    <h6 className='font-montserratSemiBold font-medium text-white text-[46px] leading-[61px] text-nowrap tracking-wider'>Subsribe For Update</h6>
                    <div className=' bg-[#1D1D1D] flex flex-col md:flex-row items-center justify-between w-full gap-5 md:gap-2 rounded-full py-3 px-3 '>
            ...
            <div className='w-full py-6 border-t border-b mt-2 border-[#262626]'>
                ...
                <div className='w-full px-24 flex gap-6'>
                ...
                <div className='w-full px-24 flex justify-end items-center text-[#E6E6E6] font-montserrat text-[18px] leading-[27px] gap-8 underline'>
