...
const ClientLogos = () => {
  ...
  return (
    <div className={`mask-gradient p-2 whitespace-nowrap overflow-hidden w-full ${hasOverflow ? 'border-b border-t border-gray-600 p-0 m-2 hide-scrollbar': ''}`}>
        <div ref={containerRef} className={`mx-auto flex items-center justify-center border-t border-b w-[100%] border-gray-900 md:w-[80%] py-10 gap-6 my-3 px-20 ${hasOverflow ? 'logo-list border-hidden' : ''} whitespace-normal`}
        >
          <img src={logo1} alt='' />
          <img src={logo2} alt='' />
          <img src={logo3} alt='' />
