...
const JoinList = () => {
  return (
    <div className='relative w-full mt-10 px-0 md:px-24 py-0 md:py-12 bg-gradient-to-b from-[#00842C] to-[#003110] overflow-hidden'>
      ...
      <div className="flex flex-col items-center gap-3 px-10 md:px-20 py-10 rounded-[0px] md:rounded-2xl bg-[#008A2E] backdrop-blur-xl">
        ...
        <button className='bg-transparent mt-8 md:mt-4 border-[1px] font-[500] text-[20px] font-montserrat leading-[26px] text-white rounded-full px-8 py-[0.92rem] md:py-[1rem] w-full md:w-auto text-nowrap'>Sign Up</button>
      </div>
    </div>
  )
}
