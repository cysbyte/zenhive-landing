...
import latest1 from '../../assets/home1/latest/latest1.png'
import latest2 from '../../assets/home1/latest/latest2.png'
import latest3 from '../../assets/home1/latest/latest3.png'
import arrow from '../../assets/home1/latest/arrow.svg'
...
const GetLatest = () => {
  ...
  return (
    <Container>
      <div className='mt-4 px-5 md:px-20 py-10 md:py-20 mx-auto'>
