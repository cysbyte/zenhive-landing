...
const JoinList = () => {
  return (
    <div className='flex flex-col mt-1 md:flex-row gap-4 md:gap-8 w-full md:w-[43%] md:min-w-[37rem] justify-start items-start md:items-end'>
        ...
        <button className='bg-[#25DAC5] font-[500] text-[20px] font-dmsans leading-[26px] text-white rounded-full px-8 py-[1.1rem] w-full md:w-auto text-nowrap'>Sign Up</button>
    </div>
  )
}
