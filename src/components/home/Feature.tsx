  ...
  return (
    <Container>
        <div className='px-20 py-20'>
            ...
            <Features/>
            <h2 className='mt-20 font-dmsans font-[700] text-[42px] leading-[52px] tracking-[-0.4px] text-black'>ZenHive’s Key Features</h2>
            <KeyFeatures/>
            <h2 className='mt-20 font-dmsans font-[500] text-[36px] leading-[40px] tracking-[-0.4px] text-[#1E0E62]'>Join the DePIN Revolution: Select Your ZenHive Role Now!</h2>
            <JoinDepin/>
