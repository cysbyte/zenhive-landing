  ...
  return (
    <Container>
      <div className='bg-black flex flex-col items-center justify-center gap-8 py-[120px] lg:py-[200px] text-center'>
        ...
        <h1 className='block md:hidden text-nowrap break-words w-auto text-white font-clashGrotesk font-[600] text-[32px] md:text-[44px] leading-[45px] md:leading-[54px] tracking-[2px] gradient-text'>The Future of <br/>Decentralized <br/>Infrastructure</h1>
        ...
        <p className='block md:hidden text-white font-cabinetGrotesk w-[90%] font-[400] text-[20px] leading-[33px] tracking-[1px]'>A Device built on aZen Protocol for Universal Computing Enabling <br/>[Decentralized Storage, AI Inferencing, Edge Computing, Content Delivery, <br/>Real-Time Analytics, IoT Solutions, Smart Contract, Decentralized Identity]</p>
